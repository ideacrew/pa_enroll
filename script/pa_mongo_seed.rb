...
#   end
  ...
  Mongo::Logger.logger.level = ::Logger::FATAL
    ...
    # CSV.foreach("db/seedfiles/opm_people.csv", :headers => true).with_index(1)  do |row,ln|
      ...
      # if @counter == 0
      #   if @sampler == 0 
          # spouse_and_kid(age,name_0,name_1,name_2,name_3,family_id_0,family_id_1, "active")
      ...
      #    @counter  = 1
      # elsif @counter == 1 
          spouse_only(age,name_8,name_9,name_0,family_id_2,family_id_3,"active") 
          # spouse_only(age,name_1,name_2,name_3,family_id_0,family_id_1,"retired") 
      #     if @people.count >= 99 
      #       db_dump
      #     end
      #   @counter = 2

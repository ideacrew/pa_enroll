WELCOME_INDEX_TRANSLATIONS = {
  ...
  "en.welcome.index.byline" => "Welcome to the Pennsylvania's Health Insurance Marketplace",
  ...
  "en.welcome.index.site_byline" => "PA's Online Health Insurance Marketplace"
}

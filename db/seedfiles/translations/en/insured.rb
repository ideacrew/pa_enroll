...
INSURED_TRANSLATIONS = {
  ...
  "en.delete" => "Delete",
  "en.deleted" => "Deleted",
  "en.insured.families.medicaid_and_tax_credits" => "Go to Medicaid",
  "en.insured.families.apply_for_medicaid_widget" => "If you qualify for Medicaid, view your Medicaid messages and find out what documents are needed.",
  ...
  "en.modal_onscreen" => "We're sending you to PA Insurance Department's Plan Match tool powered by Consumers'",
  "en.modal_onscreen1" => "CHECKBOOK. For security reasons, you'll need to login to your PA Insurance Department",
